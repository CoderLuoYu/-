...
def main():
    ...
    home_image           = pygame.image.load(r"images/home.png")
    home_destroyed_image = pygame.image.load(r"images/home_destroyed.png")
    ...
    # 敌军坦克出现动画
    appearance_image = pygame.image.load(r"images/appear.png").convert_alpha()
    appearance = []
